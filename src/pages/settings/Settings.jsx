        ...
        <div className='settings'>
            <div className="settingsWrapper">
                ...
                <form className="settingsForm">
                    ...
                    <input type="text" placeholder='Username' className='settingsTextInput' />
                    <label>Email</label>
                    <input type="email" placeholder='itsanexample@gmail.com' className='settingsTextInput' />
                    <label>Password</label>
                    <input type="password" placeholder='2yXq*Wf”@' className='settingsTextInput' />
