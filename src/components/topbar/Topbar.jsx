  ...
  return (
    <div className='top'>
      <div className="topLeft">
        <a href='https://www.instagram.com/sasasabo14/'><i className="topIcon fa-brands fa-instagram"></i></a>
        <a href='https://twitter.com/SaSaAkg'></a><i className="topIcon fa-brands fa-twitter"></i>
        <a href='https://github.com/SaSaSaBo'><i className="topIcon fa-brands fa-github"></i></a>
        <a href='https://www.linkedin.com/in/sabiha-akg%C3%BCn-64bb92284/'><i className="topIcon fa-brands fa-linkedin"></i></a>
      </div>
